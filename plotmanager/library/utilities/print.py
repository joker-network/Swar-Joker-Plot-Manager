...
def _get_row_info(pid, running_work, view_settings, as_raw_values=False, backend='joker'):
...
def get_job_data(jobs, running_work, view_settings, as_json=False, backend='joker'):
    rows = []
    added_pids = []
    for job in jobs:
...
def print_json(jobs, running_work, view_settings, backend='joker'):
