...
def monitor_jobs_to_start(jobs, running_work, max_concurrent, max_for_phase_1, next_job_work, joker_location,
...
def start_work(job, joker_location, log_directory, drives_free_space, backend):
