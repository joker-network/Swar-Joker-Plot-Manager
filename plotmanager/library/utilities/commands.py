...
def start_manager():
    ...
    joker_location, log_directory, config_jobs, manager_check_interval, max_concurrent, max_for_phase_1, \
    ...
    test_configuration(joker_location=joker_location, notification_settings=notification_settings,
